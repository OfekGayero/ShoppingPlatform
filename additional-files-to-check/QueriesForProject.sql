...
-- Query 1 : Showing all items that are from electric catagory
SELECT serial_number, item_name, price
FROM ItemsTable 
WHERE category = 'ELECTRIC';

-- Query 2 : Shows average price of items from each catagory
...
-- Query 7: Shows dave sells most expensive item
...
-- Query 8: Shows number of carts per buyer(that has atleast one cart)
